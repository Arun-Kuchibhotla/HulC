...
To make sure we have the same capabilities (e.g., same versions of packages), it's best to use an Anaconda ("conda") environment. If you are not familiar with conda you can read more about it [here](https://conda.io/projects/conda/en/latest/user-guide/install/index.html).
...
2. Change your working directory to the path of the Hulc repo. For example:
`
cd C:/Users/yourusername/Hulc/
`
